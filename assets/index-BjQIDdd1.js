 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bw="firebase-heartbeat-database",$w=1,ri="firebase-heartbeat-store";let Va=null;function Ep(){return Va||(Va=_p(Bw,$w,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(ri)}catch(n){console.warn(n)}}}}).catch(t=>{throw Wn.create("idb-open",{originalErrorMessage:t.message})})),Va}async function jw(t){try{const n=(await Ep()).transaction(ri),r=await n.objectStore(ri).get(wp(t));return await n.done,r}catch(e){if(e instanceof fr)Rn.warn(e.message);else{const n=Wn.create("idb-get",{originalErrorMessage:e?.message});Rn.warn(n.message)}}}async function Th(t,e){try{const r=(await Ep()).transaction(ri,"readwrite");await r.objectStore(ri).put(e,wp(t)),await r.done}catch(n){if(n instanceof fr)Rn.warn(n.message);else{const r=Wn.create("idb-set",{originalErrorMessage:n?.message});Rn.warn(r.message)}}}function wp(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lt(t,e){const n={typeString:t};return e&&(n.value=e),n}function di(t,e){if(!aT(t))throw new ne(H.INVALID_ARGUMENT,"JSON must be an object");let n;for(const r in e)if(e[r]){const s=e[r].typeString,i="value"in e[r]?{value:e[r].value}:void 0;if(!(r in t)){n=`JSON missing required field: '${r}'`;break}const a=t[r];if(s&&typeof a!==s){n=`JSON field '${r}' must be a ${s}.`;break}if(i!==void 0&&a!==i.value){n=`Expected '${r}' field to equal '${i.value}'`;break}}if(n)throw new ne(H.INVALID_ARGUMENT,n);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kI{constructor(){this.sessionToken=It.EMPTY_BYTE_STRING}getSessionToken(e){return k.resolve(this.sessionToken)}setSessionToken(e,n){return this.sessionToken=n,k.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qI{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=(function(){return DE()?8:pT(PE())>0?6:4})()}initialize(e,n){this.ps=e,this.indexManager=n,this.Rs=!0}getDocumentsMatchingQuery(e,n,r,s){const i={result:null};return this.ys(e,n).next((a=>{i.result=a})).next((()=>{if(!i.result)return this.ws(e,n,s,r).next((a=>{i.result=a}))})).next((()=>{if(i.result)return;const a=new jI;return this.Ss(e,n,a).next((l=>{if(i.result=l,this.Vs)return this.bs(e,n,a,l.size)}))})).next((()=>i.result))}bs(e,n,r,s){return r.documentReadCount<this.fs?(jr()<=Ie.DEBUG&&Z("QueryEngine","SDK will not create cache indexes for query:",qr(n),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),k.resolve()):(jr()<=Ie.DEBUG&&Z("QueryEngine","Query:",qr(n),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.gs*s?(jr()<=Ie.DEBUG&&Z("QueryEngine","The SDK decides to create cache indexes for query:",qr(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,un(n))):k.resolve())}ys(e,n){if(Hh(n))return k.resolve(null);let r=un(n);return this.indexManager.getIndexType(e,r).next((s=>s===0?null:(n.limit!==null&&s===1&&(n=ml(n,null,"F"),r=un(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next((i=>{const a=Se(...i);return this.ps.getDocuments(e,a).next((l=>this.indexManager.getMinOffset(e,r).next((c=>{const h=this.Ds(n,l);return this.Cs(n,h,a,c.readTime)?this.ys(e,ml(n,null,"F")):this.vs(e,h,n,c)}))))})))))}ws(e,n,r,s){return Hh(n)||s.isEqual(de.min())?k.resolve(null):this.ps.getDocuments(e,r).next((i=>{const a=this.Ds(n,i);return this.Cs(n,a,r,s)?k.resolve(null):(jr()<=Ie.DEBUG&&Z("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),qr(n)),this.vs(e,a,n,cT(s,ii)).next((l=>l)))}))}Ds(e,n){let r=new gt(Hp(e));return n.forEach(((s,i)=>{$o(e,i)&&(r=r.add(i))})),r}Cs(e,n,r,s){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const i=e.limitType==="F"?n.last():n.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Ss(e,n,r){return jr()<=Ie.DEBUG&&Z("QueryEngine","Using full collection scan to execute query:",qr(n)),this.ps.getDocumentsMatchingQuery(e,n,sr.min(),r)}vs(e,n,r,s){return this.ps.getDocumentsMatchingQuery(e,r,s).next((i=>(n.forEach((a=>{i=i.insert(a.key,a)})),i)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lg=1e4,Fg=`w:${Cc}`,Ug="FIS_v2",ZA="https://firebaseinstallations.googleapis.com/v1",eb=3600*1e3,tb="installations",nb="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rb={"missing-app-config-values":'Missing App configuration value: "{$valueName}"',"not-registered":"Firebase Installation is not registered.","installation-not-found":"Firebase Installation not found.","request-failed":'{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',"app-offline":"Could not process request. Application offline.","delete-pending-registration":"Can't delete installation while there is a pending registration request."},Vr=new No(tb,nb,rb);function Bg(t){return t instanceof fr&&t.code.includes("request-failed")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ab({appConfig:t,heartbeatServiceProvider:e},{fid:n}){const r=$g(t),s=Hg(t),i=e.getImmediate({optional:!0});if(i){const h=await i.getHeartbeatsHeader();h&&s.append("x-firebase-client",h)}const a={fid:n,authVersion:Ug,appId:t.appId,sdkVersion:Fg},l={method:"POST",headers:s,body:JSON.stringify(a)},c=await zg(()=>fetch(r,l));if(c.ok){const h=await c.json();return{fid:h.fid||n,registrationStatus:2,refreshToken:h.refreshToken,authToken:jg(h.authToken)}}else throw await qg("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cb=/^[cdef][\w-]{21}$/,Sl="";function ub(){try{const t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16;const n=hb(t);return cb.test(n)?n:Sl}catch{return Sl}}function hb(t){return lb(t).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gg=new Map;function Wg(t,e){const n=Wo(t);Qg(n,e),fb(n,e)}function Qg(t,e){const n=Gg.get(t);if(n)for(const r of n)r(e)}function fb(t,e){const n=db();n&&n.postMessage({key:t,fid:e}),pb()}let Ir=null;function db(){return!Ir&&"BroadcastChannel"in self&&(Ir=new BroadcastChannel("[Firebase] FID Change"),Ir.onmessage=t=>{Qg(t.data.key,t.data.fid)}),Ir}function pb(){Gg.size===0&&Ir&&(Ir.close(),Ir=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vc(t){let e;const n=await Qo(t.appConfig,r=>{const s=_b(r),i=yb(t,s);return e=i.registrationPromise,i.installationEntry});return n.fid===Sl?{installationEntry:await e}:{installationEntry:n,registrationPromise:e}}function _b(t){const e=t||{fid:ub(),registrationStatus:0};return Xg(e)}function yb(t,e){if(e.registrationStatus===0){if(!navigator.onLine){const s=Promise.reject(Vr.create("app-offline"));return{installationEntry:e,registrationPromise:s}}const n={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},r=vb(t,n);return{installationEntry:n,registrationPromise:r}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:Eb(t)}:{installationEntry:e}}async function vb(t,e){try{const n=await ab(t,e);return mo(t.appConfig,n)}catch(n){throw Bg(n)&&n.customData.serverCode===409?await Yg(t.appConfig):await mo(t.appConfig,{fid:e.fid,registrationStatus:0}),n}}async function Eb(t){let e=await Af(t.appConfig);for(;e.registrationStatus===1;)await Kg(100),e=await Af(t.appConfig);if(e.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=await Vc(t);return r||n}return e}function Af(t){return Qo(t,e=>{if(!e)throw Vr.create("installation-not-found");return Xg(e)})}function Xg(t){return wb(t)?{fid:t.fid,registrationStatus:0}:t}function wb(t){return t.registrationStatus===1&&t.registrationTime+Lg<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Tb({appConfig:t,heartbeatServiceProvider:e},n){const r=Ib(t,n),s=sb(t,n),i=e.getImmediate({optional:!0});if(i){const h=await i.getHeartbeatsHeader();h&&s.append("x-firebase-client",h)}const a={installation:{sdkVersion:Fg,appId:t.appId}},l={method:"POST",headers:s,body:JSON.stringify(a)},c=await zg(()=>fetch(r,l));if(c.ok){const h=await c.json();return jg(h)}else throw await qg("Generate Auth Token",c)}function Ib(t,{fid:e}){return`${$g(t)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xc(t,e=!1){let n;const r=await Qo(t.appConfig,i=>{if(!Jg(i))throw Vr.create("not-registered");const a=i.authToken;if(!e&&Sb(a))return i;if(a.requestStatus===1)return n=Ab(t,e),i;{if(!navigator.onLine)throw Vr.create("app-offline");const l=Cb(i);return n=bb(t,l),l}});return n?await n:r.authToken}async function Ab(t,e){let n=await bf(t.appConfig);for(;n.authToken.requestStatus===1;)await Kg(100),n=await bf(t.appConfig);const r=n.authToken;return r.requestStatus===0?xc(t,e):r}function bf(t){return Qo(t,e=>{if(!Jg(e))throw Vr.create("not-registered");const n=e.authToken;return Pb(n)?{...e,authToken:{requestStatus:0}}:e})}async function bb(t,e){try{const n=await Tb(t,e),r={...e,authToken:n};return await mo(t.appConfig,r),n}catch(n){if(Bg(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await Yg(t.appConfig);else{const r={...e,authToken:{requestStatus:0}};await mo(t.appConfig,r)}throw n}}function Jg(t){return t!==void 0&&t.registrationStatus===2}function Sb(t){return t.requestStatus===2&&!Rb(t)}function Rb(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+eb}function Cb(t){const e={requestStatus:1,requestTime:Date.now()};return{...t,authToken:e}}function Pb(t){return t.requestStatus===1&&t.requestTime+Lg<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vb(t){const e=t,{installationEntry:n,registrationPromise:r}=await Vc(e);return r?r.catch(console.error):xc(e).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xb(t,e=!1){const n=t;return await Db(n),(await xc(n,e)).token}async function Db(t){const{registrationPromise:e}=await Vc(t);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zg="installations",Ob="installations-internal",Mb=t=>{const e=t.getProvider("app").getImmediate(),n=Nb(e),r=fi(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},kb=t=>{const e=t.getProvider("app").getImmediate(),n=fi(e,Zg).getImmediate();return{getId:()=>Vb(n),getToken:s=>xb(n,s)}};function Lb(){rr(new Sn(Zg,Mb,"PUBLIC")),rr(new Sn(Ob,kb,"PRIVATE"))}Lb();cn(kg,Cc);cn(kg,Cc,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _o="analytics",Fb="firebase_id",Ub="origin",Bb=60*1e3,$b="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",Dc="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qb(t){if(!t.startsWith(Dc)){const e=Gt.create("invalid-gtag-resource",{gtagURL:t});return $t.warn(e.message),""}return t}function em(t){return Promise.all(t.map(e=>e.catch(n=>n)))}function Hb(t,e){let n;return window.trustedTypes&&(n=window.trustedTypes.createPolicy(t,e)),n}function zb(t,e){const n=Hb("firebase-js-sdk-policy",{createScriptURL:qb}),r=document.createElement("script"),s=`${Dc}?l=${t}&id=${e}`;r.src=n?n?.createScriptURL(s):s,r.async=!0,document.head.appendChild(r)}function Kb(t){let e=[];return Array.isArray(window[t])?e=window[t]:window[t]=e,e}async function Gb(t,e,n,r,s,i){const a=r[s];try{if(a)await e[a];else{const c=(await em(n)).find(h=>h.measurementId===s);c&&await e[c.appId]}}catch(l){$t.error(l)}t("config",s,i)}async function Wb(t,e,n,r,s){try{let i=[];if(s&&s.send_to){let a=s.send_to;Array.isArray(a)||(a=[a]);const l=await em(n);for(const c of a){const h=l.find(p=>p.measurementId===c),f=h&&e[h.appId];if(f)i.push(f);else{i=[];break}}}i.length===0&&(i=Object.values(e)),await Promise.all(i),t("event",r,s||{})}catch(i){$t.error(i)}}function Qb(t,e,n,r){async function s(i,...a){try{if(i==="event"){const[l,c]=a;await Wb(t,e,n,l,c)}else if(i==="config"){const[l,c]=a;await Gb(t,e,n,r,l,c)}else if(i==="consent"){const[l,c]=a;t("consent",l,c)}else if(i==="get"){const[l,c,h]=a;t("get",l,c,h)}else if(i==="set"){const[l]=a;t("set",l)}else t(i,...a)}catch(l){$t.error(l)}}return s}function Yb(t,e,n,r,s){let i=function(...a){window[r].push(arguments)};return window[s]&&typeof window[s]=="function"&&(i=window[s]),window[s]=Qb(i,t,e,n),{gtagCore:i,wrappedGtag:window[s]}}function Xb(t){const e=window.document.getElementsByTagName("script");for(const n of Object.values(e))if(n.src&&n.src.includes(Dc)&&n.src.includes(t))return n;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jb=30,Zb=1e3;class e0{constructor(e={},n=Zb){this.throttleMetadata=e,this.intervalMillis=n}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,n){this.throttleMetadata[e]=n}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const tm=new e0;function t0(t){return new Headers({Accept:"application/json","x-goog-api-key":t})}async function n0(t){const{appId:e,apiKey:n}=t,r={method:"GET",headers:t0(n)},s=$b.replace("{app-id}",e),i=await fetch(s,r);if(i.status!==200&&i.status!==304){let a="";try{const l=await i.json();l.error?.message&&(a=l.error.message)}catch{}throw Gt.create("config-fetch-failed",{httpStatus:i.status,responseMessage:a})}return i.json()}async function r0(t,e=tm,n){const{appId:r,apiKey:s,measurementId:i}=t.options;if(!r)throw Gt.create("no-app-id");if(!s){if(i)return{measurementId:i,appId:r};throw Gt.create("no-api-key")}const a=e.getThrottleMetadata(r)||{backoffCount:0,throttleEndTimeMillis:Date.now()},l=new o0;return setTimeout(async()=>{l.abort()},Bb),nm({appId:r,apiKey:s,measurementId:i},a,l,e)}async function nm(t,{throttleEndTimeMillis:e,backoffCount:n},r,s=tm){const{appId:i,measurementId:a}=t;try{await s0(r,e)}catch(l){if(a)return $t.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${l?.message}]`),{appId:i,measurementId:a};throw l}try{const l=await n0(t);return s.deleteThrottleMetadata(i),l}catch(l){const c=l;if(!i0(c)){if(s.deleteThrottleMetadata(i),a)return $t.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${c?.message}]`),{appId:i,measurementId:a};throw l}const h=Number(c?.customData?.httpStatus)===503?mh(n,s.intervalMillis,Jb):mh(n,s.intervalMillis),f={throttleEndTimeMillis:Date.now()+h,backoffCount:n+1};return s.setThrottleMetadata(i,f),$t.debug(`Calling attemptFetch again in ${h} millis`),nm(t,f,r,s)}}function s0(t,e){return new Promise((n,r)=>{const s=Math.max(e-Date.now(),0),i=setTimeout(n,s);t.addEventListener(()=>{clearTimeout(i),r(Gt.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function i0(t){if(!(t instanceof fr)||!t.customData)return!1;const e=Number(t.customData.httpStatus);return e===429||e===500||e===503||e===504}class o0{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function a0(t,e,n,r,s){if(s&&s.global){t("event",n,r);return}else{const i=await e,a={...r,send_to:i};t("event",n,a)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function l0(){if(dp())try{await pp()}catch(t){return $t.warn(Gt.create("indexeddb-unavailable",{errorInfo:t?.toString()}).message),!1}else return $t.warn(Gt.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function c0(t,e,n,r,s,i,a){const l=r0(t);l.then(g=>{n[g.measurementId]=g.appId,t.options.measurementId&&g.measurementId!==t.options.measurementId&&$t.warn(`The measurement ID in the local Firebase config (${t.options.measurementId}) does not match the measurement ID fetched from the server (${g.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(g=>$t.error(g)),e.push(l);const c=l0().then(g=>{if(g)return r.getId()}),[h,f]=await Promise.all([l,c]);Xb(i)||zb(i,h.measurementId),s("js",new Date);const p=a?.config??{};return p[Ub]="firebase",p.update=!0,f!=null&&(p[Fb]=f),s("config",h.measurementId,p),h.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
